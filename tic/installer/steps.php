...
/////////////////////////////////////////////////////
    ...
    function step5($data)
    {
        ...
        \$pfadzumtick = '".$_SESSION['install']['tic_adress']."'; // Der Schr�gstrich am Ende ist wichtig!
    ...
    ?>");
        ...
        $mysql->insert("gn4meta", "name, sysmsg", "'".$_POST['meta_name']."', 'Wenn dieser Text zu lesen ist dann ist leuft der TIC diese Nachricht kann unter Managment ge�ndert werden.'") or die($mysql->error(__FILE__,__LINE__));
